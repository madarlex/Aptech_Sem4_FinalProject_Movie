				  ...
				  <div class="container-fluid h-custom">
				    <div class="row d-flex justify-content-center align-items-center h-100">
				      ...
				      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
				        <s:form method="post" modelAttribute="resetPassword" action="${pageContext.request.contextPath}/account/resetPassword" id="resetPasswordForm">
				          ...
				          <div class="form-outline mb-3">
				              <s:password path="confirmPassword" class="form-control form-control-lg account" id="confirmPassword"  placeholder="Enter your confirm password..." />
