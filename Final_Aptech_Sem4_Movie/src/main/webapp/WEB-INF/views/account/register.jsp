			...
			$(document).ready(function() {
				$("#loginForm").validate({
					...
					messages: {
						...
						Email: {
							required: "Please Input Data For Email",
			...
			<div class="col-md-12">
				<div class="hero-ct">
					...
					<ul class="breadcumb">
						...
						<li> <span class="ion-ios-arrow-right"></span> Register</li>
					</ul>
				</div>
			</div>
		</div>
				  ...
				  <div class="container-fluid h-custom">
				    <div class="row d-flex justify-content-center align-items-center h-100">
				      ...
				      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
				        <s:form method="post" modelAttribute="account" action="${pageContext.request.contextPath}/account/register" id="loginForm">
				          ...
				          <div class="form-outline mb-4">
				              <s:input path="username" class="form-control form-control-lg account" id="username" placeholder="Enter your username..."  />
				          </div>
				          <div class="form-outline mb-3">
				              <s:password path="password" class="form-control form-control-lg account" id="password"  placeholder="Enter your password..." />
				          </div>
							<div class="form-outline mb-4">
				              <s:input path="email" class="form-control form-control-lg account" id="email" placeholder="Enter your email..."  />
				          </div>
				          <div class="form-outline mb-4">
