				...
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							<!-- choose hall name -->
							<s:form method="post"
								action="${pageContext.request.contextPath }/admin/hall/edit"
								modelAttribute="hall">
								...
								<div class="form-group row mb-4">
									<label
										class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Seat
										quantity</label>
									<div class="col-sm-12 col-md-7">
										<s:input type="number" class="form-control" path="seatNumbers" />
									</div>
								</div>
