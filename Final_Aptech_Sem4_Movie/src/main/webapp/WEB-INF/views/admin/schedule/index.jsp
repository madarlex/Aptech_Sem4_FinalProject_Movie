									...
									<div class="col-sm-12 col-md-9">
										<select class="form-control selectric" name="hall">
											<c:forEach var="hall" items="${hallList }">
												<option value="${hall.id }" ${hallId != null ? (hallId == hall.id ? "selected" : "") : "" }>${hall.name }</option>
											</c:forEach>
										</select>
									</div>
								</div>
									...
									<div class="col-sm-12 col-md-9">
										<select class="form-control select2" name="movie">
											<c:forEach var="movie" items="${movieList }">
												<option value="${movie.id }" ${movieId != null ? (movieId == movie.id ? "selected" : "") : "" }>${movie.name }</option>
											</c:forEach>
										</select>
									</div>
								</div>
