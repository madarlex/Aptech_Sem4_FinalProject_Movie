	...
	<div class="card">
		...
		<div class="card-body">
			<div class="form-group">
				<form
					action="${pageContext.request.contextPath }/admin/feedback/search"
					method="post">
					<div class="row">
						<div class="col-9">
					...
					<c:forEach var="f" items="${feedbacks }" varStatus="i">
						<tr>
							...
							<td>
								...
								href="${pageContext.request.contextPath }/admin/feedback/delete/${f.id}"
			...
			<nav class="d-inline-block">
				<ul class="pagination mb-0">
					<li class="page-item ${preCheck }"><a class="page-link"
						href="${pageContext.request.contextPath }/admin/feedback/feedbacks/${currentPage - 1}"
					...
					<li class="page-item active"><a class="page-link"
						href="${pageContext.request.contextPath }/admin/feedback/feedbacks/<%= i+1 %>"><%=i + 1%></a></li>
					<%
					} else {
					%>
					...
					<li class="page-item ${nextCheck }"><a class="page-link"
						href="${pageContext.request.contextPath }/admin/feedback/feedbacks/${currentPage +1}"><i
