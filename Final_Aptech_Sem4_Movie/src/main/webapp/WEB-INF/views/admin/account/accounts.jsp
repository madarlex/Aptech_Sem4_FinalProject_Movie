				...
				<table class="table table-striped table-md">
					...
					<c:forEach var="a" items="${accounts }" varStatus="i" >
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath }/admin/account/edit/${a.id}" class="btn btn-primary">
								...
								<a href="${pageContext.request.contextPath }/admin/account/delete/${a.id}" class="btn btn-primary">
									<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" 
