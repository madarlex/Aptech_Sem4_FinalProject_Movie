			...
			<div class="row">
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							<s:form modelAttribute="movie" action="${pageContext.request.contextPath }/admin/movie/add"
							...
							<div class="form-group row mb-4">
								...
								<div class="col-sm-12 col-md-7">
									<div class="input-group">
										<s:input type="date" path="startDate" class="form-control daterange-cus"/> 
										<label
									class="col-form-label text-md-right col-12 col-md-3 col-lg-3">End Date</label>
										<s:input type="date" path="endDate" class="form-control daterange-cus"/>
									</div>
								</div>
							</div>
